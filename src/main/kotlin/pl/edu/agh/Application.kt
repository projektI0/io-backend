...
import pl.edu.agh.tag.AuthModule.getKoinTagModule
...
fun Application.module() {
    ...
    initDB()
    install(Koin) {
        modules(getKoinAuthModule(), getKoinShoppingListModule(), getKoinProductModule(), getKoinShopModule(), getKoinPathModule(), getKoinTagModule())
    }
    configureSecurity()
    configureAuthRoutes()
